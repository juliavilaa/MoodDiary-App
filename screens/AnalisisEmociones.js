      ...
      {opciones.map((op) => (
        ...
        >
          <Text
            style={[
              styles.filtroTexto,
              activo === op && styles.filtroTextoActivo,
            ]}
          >
            {op}
          </Text>
...
export default function AnalisisEmociones({ navigation }) {
  ...
  const emocionesCalculadas = Object.entries(conteo)
    .map(([nombre, cant]) => {
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          <View style={styles.vacioCentrado}>
            ...
            <Text style={styles.vacioSub}>
              Registra tus primeras emociones para ver el análisis aquí.
            </Text>
            <TouchableOpacity
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.tarjetasRow}>
            <View
              style={[styles.tarjetaRapida, { backgroundColor: PURPLE + "18" }]}
            >
              <Ionicons
                ...
                color={PURPLE_DARK}
              />
              <Text style={styles.tarjetaNum}>
                {emocionesCalculadas.length}
              </Text>
              <Text style={styles.tarjetaLabel}>Tipos de{"\n"}emoción</Text>
            </View>

            <View
              style={[styles.tarjetaRapida, { backgroundColor: PINK + "40" }]}
            >
              <Ionicons
                name={emocionTop?.icono || "help-outline"}
                size={22}
                color={PURPLE_DARK}
              />
            ...
            <View
              style={[styles.tarjetaRapida, { backgroundColor: SALMON + "20" }]}
            >
              <Ionicons name="list-outline" size={22} color={SALMON} />
              <Text style={[styles.tarjetaNum, { color: SALMON }]}>
                {total}
              </Text>
          ...
          <View style={styles.emocionesGrid}>
            {emocionesCalculadas.map((e, i) => (
              ...
              >
                ...
                <Text style={[styles.emocionNombre, { color: e.textColor }]}>
                  {e.nombre}
                </Text>
              ...
              {historialReciente.map((h, i) => (
                <View key={i} style={styles.historialItem}>
                  ...
                  <View style={styles.historialInfo}>
                    ...
                    <Text style={styles.historialFecha} numberOfLines={1}>
                      {h.descripcion}
                    </Text>
                  </View>
                  <View
                    style={[
                      styles.historialPill,
                      { backgroundColor: h.color + "30" },
                    ]}
                  >
                    <Text
                      style={[styles.historialPillTexto, { color: h.color }]}
                    >
                      {h.fecha}
                    </Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  tarjetaRapida: {
    ...
    gap: 4,
    borderWidth: 0.5,
    borderColor: "rgba(180,130,220,0.2)",
  },
